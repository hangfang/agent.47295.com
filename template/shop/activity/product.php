	       ...
	       <div class="col-md-7-bak">
               <?php 
                ...
                for($i=0,$len=count($data['list']); $i<$len; $i++){
                    ...
                    $_product['product_image'] = str_replace(CDN_URL_PLACEHOLDER, IMG_CDN_URL, $_product['product_image']);
    ...
    <div class="shop-holder">
         <div class="product-img">
            <a href="/shop/product/detail?product_id={$_product['product_id']}">
                <img width_bak="225" height_bak="265" data-original="{$_product['product_image']}" src="{$STATIC_CDN_URL}{$staticDir}images/default.png" class="lazy img-responsive"  alt="item4" style="height:17rem;">
            </a>
            ...
            $(document).scroll(function(){
                ...
                if(tmp < 1.05){
                    ...
                    $.ajax({
                        ...
                        type:'get',
                        dataType:'json',
                        data:{'offset':offset, 'length':12, 'activity_id':<?php echo $activity['activity_id'];?>},
