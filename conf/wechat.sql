...
CREATE TABLE `token` (
  ...
  `jsapi_ticket` varchar(255) NOT NULL DEFAULT '' COMMENT 'jsapi鉴权的ticket',
  `token` varchar(255) NOT NULL DEFAULT '' COMMENT '微信授权token',
